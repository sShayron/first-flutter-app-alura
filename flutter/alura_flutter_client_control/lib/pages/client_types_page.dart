...
class _ClientTypesPageState extends State<ClientTypesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<Types>(
        builder: (BuildContext context, Types typesProvider, Widget? widget) =>
            ListView.builder(
          ...
          itemBuilder: (context, index) {
            return Dismissible(
              ...
              child: ListTile(
                leading: Icon(typesProvider.types[index].icon),
                title: Text(typesProvider.types[index].name),
                iconColor: Colors.deepOrange,
              ),
              onDismissed: (direction) {
                typesProvider.remove(index);
              },
            );
          },
        ),
